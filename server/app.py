...
def search():
    ...
    output_folder = '/Users/hercules/Desktop/Speakify/client/public/'
    ...
    params = {
      "api_key": "7ea0129044f90a519604a313c2a40733d03763288afbfcc80d4299d2d97b03ba",
      "engine": "google",
      "q": keyword,
    }
    ...
    try:
        ...
        if "shopping_results" in results and title_element and price_element:
