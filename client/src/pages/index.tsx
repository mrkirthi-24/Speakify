    ...
    <div className="flex flex-col text-center mt-40">
      ...
      {loading ? (
        ...
        productDetails.status === "error" ? (
          <div className="flex justify-center mt-6">
            <p>No shopping ads found for {noAds}</p>
          </div>
        ) : (
      ...
      <footer className="w-full absolute bottom-10 text-center">
        Made with ❤️ by{" "}
        <a href="https://mrkirthi24.netlify.app/">Kirthi Bagrecha Jain</a>
      </footer>
    </div>
  );
};
